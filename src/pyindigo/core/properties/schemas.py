...
class CommonProperties(IndigoPropertiesNamespace):
    ...
    CONFIG = PropertySchema(
        ...
        SwitchVectorProperty,
        ["LOAD", "SAVE", "REMOVE"],
        rule=IndigoSwitchRule.AT_MOST_ONE,
    )
    ...
    PROFILE = PropertySchema(
        "PROFILE",
        SwitchVectorProperty,
        [f"PROFILE_{i}" for i in range(100)],
        rule=IndigoSwitchRule.EXACTLY_ONE,
    )
    ...
    DEVICE_PORTS = PropertySchema(
        "DEVICE_PORTS", SwitchVectorProperty, [], rule=IndigoSwitchRule.EXACTLY_ONE
    )
...
class CCDSpecificProperties(IndigoPropertiesNamespace):
    ...
    CCD_FRAME = PropertySchema(
        "CCD_FRAME", NumberVectorProperty, ["LEFT", "TOP", "WIDTH", "HEIGHT", "BITS_PER_PIXEL"]
    )
    ...
    CCD_MODE = PropertySchema(
        "CCD_MODE", SwitchVectorProperty, [], rule=IndigoSwitchRule.EXACTLY_ONE
    )

    CCD_READ_MODE = PropertySchema(
        "CCD_READ_MODE",
        SwitchVectorProperty,
        ["HIGH_SPEED", "LOW_NOISE"],
        rule=IndigoSwitchRule.EXACTLY_ONE,
    )
    ...
    CCD_COOLER = PropertySchema(
        "CCD_COOLER", SwitchVectorProperty, ["ON", "OFF"], rule=IndigoSwitchRule.EXACTLY_ONE
    )
    ...
    CCD_FITS_HEADERS = PropertySchema(
        "CCD_FITS_HEADERS", TextVectorProperty, [f"HEADER_{i}" for i in range(100)]
    )
